...
const TEST = [
    {
      image:'https://binhminhmedic.com/wp-content/uploads/2025/02/binh-khi-moi-cong-nghiep-viet-1-768x576.jpg',
      title:'Dịch vụ oxy y tế, oxy thở tận nhà 24/24 TP HCM',
      excerpt: 'Y TẾ BÌNH MINH chuyên cung ứng Dịch vụ oxy y tế, oxy thở tận...'
    },
    {
      image:'https://binhminhmedic.com/wp-content/uploads/2025/02/images-2-2.jpg',
      title:'Cho thuê máy thở Oxy tại nhà khu vực Hồ Chí Minh 24/7',
      excerpt: 'CHO THUÊ MÁY THỞ OXY TẠI HỒ CHÍ MINH – GIẢI PHÁP HỖ TRỢ HÔ...'
    },
    {
      image:'https://binhminhmedic.com/wp-content/uploads/2025/02/images-4.jpg',
      title:'Tiết kiệm chi phí với dịch vụ cho thuê máy thở oxy và máy tạo oxy',
      excerpt: 'Trong bài viết này chúng tôi sẽ giới thiệu dịch vụ thuê bình oxy (bình oxy y.)'
    },
    {
...
export default function MaythoOxy() {
